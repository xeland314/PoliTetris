...
public abstract class TetrominoeBase implements Movimiento, Serializable, Cloneable, Comparable<TetrominoeBase> {
    ...
    public TetrominoeBase(String nombre, int[][] figura, Color color) {
        this.nombre = nombre;
        this.figura = figura;
        this.color = color;
        this.x = 0;
    ...
    @Override
    public int compareTo(TetrominoeBase pieza) {
        return this.getNombre().compareTo(pieza.getNombre());
    }

    @Override
    public Object clone() throws CloneNotSupportedException {
        TetrominoeBase formaClonada = (TetrominoeBase) super.clone();
        return formaClonada;
    }
